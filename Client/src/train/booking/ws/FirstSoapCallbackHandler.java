 ...
 */
    ...
    /**
     *  FirstSoapCallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class FirstSoapCallbackHandler{
    ...
    */
    public FirstSoapCallbackHandler(Object clientData){
    ...
    */
    public FirstSoapCallbackHandler(){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultsayHello(
                    train.booking.ws.FirstSoapStub.SayHelloResponse result
                        ) {
           }
